...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.fleetListAgents]: AuthOrchestrationReadScope,
  [WS_METHODS.fleetReadThread]: AuthOrchestrationReadScope,
  [WS_METHODS.fleetSendMessage]: AuthOrchestrationOperateScope,
  [WS_METHODS.fleetSubscribe]: AuthOrchestrationReadScope,
